    ...
    <header className="bg-secondary shadow-lg">
      <div className="bg-primary p-2 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-center font-medium text-sm relative z-10 flex items-center justify-center gap-2">
            ...
            <Link
              to="tel:+250782986810"
              className="text-white inline-flex items-center hover:text-yellow-300 transition-colors duration-300 text-xs sm:text-sm"
            >
      ...
      <nav className="max-w-7xl mx-auto flex justify-between items-center py-3 px-6">
        <div className="flex items-center">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-white text-lg font-bold hover:text-primary transition-colors duration-300">
              Fixo
            </span>
          </Link>
        </div>
        ...
        <div className="hidden md:flex items-center gap-8">
          <ul className="flex gap-8 font-medium text-sm">
            ...
            <li>
              ...
              >
                ...
                <span>{lang === 'en' ? 'Services' : 'Serivise'}</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                <span>{lang === 'en' ? 'Products' : 'Ibicuruzwa'}</span>
              </Link>
            </li>
            <li>
              <Link
          ...
          <div className="flex items-center gap-4">
            <Link
              to="/direct-support"
              className="group relative overflow-hidden bg-primary hover:bg-primary-dark px-4 py-2 rounded-md shadow-lg transform hover:scale-105 transition-all duration-300 animate-pulse"
            >
              ...
              <div className="relative flex items-center gap-2 text-sm text-white font-medium">
            ...
            <button
              ...
              className="flex items-center gap-1.5 py-1.5 px-3 bg-opacity-20 bg-white backdrop-blur-sm rounded-md hover:bg-opacity-30 transition duration-300 text-sm text-white"
            >
              <img
                src={
                  lang === 'en'
        ...
        {isMenuOpen && (
          <div className="md:hidden fixed inset-0 bg-secondary bg-opacity-95 z-50">
            <div className="flex flex-col h-full">
              ...
              <ul className="flex flex-col items-center gap-6 p-6 text-sm">
                <li>
                  <Link
                    to="/"
                ...
                <li>
                  <Link
                    to="/direct-support"
                    className="bg-primary hover:bg-primary-dark px-4 py-2 rounded-md shadow-lg text-white flex items-center gap-2 transform hover:scale-105 transition-all duration-300 animate-pulse"
                    onClick={toggleMenu}
                  >
                ...
                <li>
                  <button
                    onClick={handleLanguageSwitch}
                    className="flex items-center gap-1.5 py-1.5 px-3 bg-white bg-opacity-10 rounded-md hover:bg-opacity-20 transition duration-300 text-sm text-white"
                  >
                    <img
                      src={
                        lang === 'en'
