...
const Footer = ({ lang }: { lang: string }) => {
  ...
  const features = [
    {
      icon: FaShieldAlt,
      text: { en: 'Secure & Reliable', rw: "Umutekano n'Uwizigirwa" },
    },
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="lg:col-span-1">
              ...
              >
                <img src="./logo-white.png" alt="Fixo Logo"  className='h-16'/>
              </Link>
              ...
              <div className="space-y-3">
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <span>
                      {lang === 'en' ? feature.text.en : feature.text.rw}
                    </span>
                  </div>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 text-gray-300 text-sm">
                  ...
                  <span>
                    {lang === 'en' ? '24/7 - all time' : '24/7 - igihe cyose'}
                  </span>
                </div>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder={
                    lang === 'en' ? 'Enter your email' : 'Andika imeyili yawe'
                  }
                ...
                <button
                  disabled
                  className="bg-secondary  text-white font-semibold py-3 px-6 rounded-xl"
                >
